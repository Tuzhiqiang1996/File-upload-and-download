      ...
      <div class="analysis-content-body">
        <div class="upload-tool">
          <span>
            ...
            />
            <el-button type="success" size="small" @click="btnClick"
              >上传excel</el-button
            >
          </span>

          <el-button type="primary" @click="openColumnDrawer" size="small"
            >查看显示列</el-button
          >
        </div>
        ...
        >
          <div
            ...
            style="overflow: auto; width: 100%; background: #fff"
          >
            ...
            <div class="drawer-footer" style="">
              <el-button @click="closeColumnDrawer" size="small"
                >取 消</el-button
              >
            </div>
          </div>
